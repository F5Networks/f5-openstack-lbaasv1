...
class BigIQ(object):
    ...
    def __init__(self, hostname, username, password):
        ...
        passMgr.add_password('REST Framework', self.hostname, self.username, self.password)
        ...
        # If we are able to successfully query the echo worker we consider ourselves connected
