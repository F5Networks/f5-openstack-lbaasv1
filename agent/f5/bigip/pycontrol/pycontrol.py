...
AGREEMENT FOR F5 Software Development Kit for iControl"; you
may not use this file except in compliance with the License.
The License is included in the iControl Software Development Kit.
...
Inc. Seattle, WA, USA. Portions created by F5 are Copyright
(C) 1996-2004 F5 Networks,
Inc. All Rights Reserved.  iControl (TM) is a registered
...
This version of pycontrol and its improvements are possible because
of the Suds SOAP package, written and maintained by Jeff Ortel.
Please see https://fedorahosted.org/suds/ for more information on
Suds. We thank Jeff for his excellent work!
"""
