...
class LBaaSBuilderBigiqIApp(LBaaSBuilder):
    ...
    def exists(self, service):
        ...
        try:
            ...
            tenant_name = LBaaSBuilderBigiqIApp._tenant_name(project_id)

            pool_id = service['pool']['id']

            service_name = LBaaSBuilderBigiqIApp._tenant_service_name(pool_id)
    ...
    def _assure_tenant_service(self, service):
        ...
        tenant_service = LBaaSBuilderBigiqIApp._tenant_service(
            service, connector)
    ...
    def _tenant_service(os_service, connector):
        ...
        # }
        tenant_service['name'] = \
            LBaaSBuilderBigiqIApp._tenant_service_name(pool_id)
        ...
        LBaaSBuilderBigiqIApp._fill_in_pool_info(tenant_service, os_service)
        LBaaSBuilderBigiqIApp._fill_in_vip_info(tenant_service, os_service)

        tenant_service['vars'].append(
            LBaaSBuilderBigiqIApp._tenant_service_var('app_stats', 'enabled'))
        ...
        LBaaSBuilderBigiqIApp._fill_in_pool_members_table(
            tenant_service, os_service)
    ...
    @staticmethod
    def _fill_in_pool_info(tenant_service, os_service):
        ...
        pool_lb_method_var = LBaaSBuilderBigiqIApp._pool_lb_method_var(os_pool)
        ...
        # This isn't required per the f5.lbaas iApp template
        pool_monitor_var = \
            LBaaSBuilderBigiqIApp._pool_monitor_var(os_service)
    ...
    def _pool_lb_method_var(os_pool):
        ...
        ltm_lb_method = LBaaSBuilderBigiqIApp._LTM_LB_METHODS.get(
            os_pool['lb_method'])
        ...
        return LBaaSBuilderBigiqIApp._tenant_service_var(
    ...
    def _pool_monitor_var(os_service):
        ...
        for health_monitor in os_service['health_monitors']:
            ...
            templ_map = LBaaSBuilderBigiqIApp._IAPP_TEMPLATE_MONITOR_TYPES
    ...
    @staticmethod
    def _fill_in_vip_info(tenant_service, os_service):
        ...
        vip_addr_var = LBaaSBuilderBigiqIApp._vip_addr_var(os_vip)
        ...
        tenant_service['vars'].append(
            LBaaSBuilderBigiqIApp._tenant_service_var(
                'pool__addr', vip_addr_var['value']))

        vip_persist_var = LBaaSBuilderBigiqIApp._vip_persist_var(
            os_vip)
        ...
        vip_cookie_var = LBaaSBuilderBigiqIApp._vip_cookie_var(
            os_vip)
        ...
        vip_port_var = LBaaSBuilderBigiqIApp._vip_port_var(os_vip)
        ...
        if vip_port_var:
            ...
            tenant_service['vars'].append(
                LBaaSBuilderBigiqIApp._tenant_service_var(
                    'pool__port', vip_port_var['value']))

        vip_protocol_var = LBaaSBuilderBigiqIApp._vip_protocol_var(
            os_vip)
        ...
        vip_state_var = LBaaSBuilderBigiqIApp._vs_state_var(os_vip)
    ...
    def _vip_addr_var(os_vip):
        ...
        if not (os_vip and 'id' in os_vip and os_vip['id']
            ...
            return LBaaSBuilderBigiqIApp._default_dynamic_vip_addr_var()

        return LBaaSBuilderBigiqIApp._tenant_service_var(
            'vip__addr', os_vip['address'])
    ...
    def _vip_persist_var(os_vip):
        ...
        if not (os_vip and
            ...
            return None
        templ_map = LBaaSBuilderBigiqIApp._IAPP_TEMPLATE_PERSIST_TYPES
    ...
    def _vip_port_var(os_vip):
        ...
        return LBaaSBuilderBigiqIApp._tenant_service_var(
            'vip__port', os_vip['protocol_port'])
    ...
    def _vip_protocol_var(os_vip):
        ...
        prof_map = LBaaSBuilderBigiqIApp._LTM_PROFILE_TYPES
        ...
        return LBaaSBuilderBigiqIApp._tenant_service_var(
            'vip__protocol', ltm_profile_type)
    ...
    def _vs_state_var(os_vip):
        ...
        return LBaaSBuilderBigiqIApp._tenant_service_var(
            'vip__state',
            LBaaSBuilderBigiqIApp._LTM_VS_STATES[os_vip['admin_state_up']])

    @staticmethod
    def _fill_in_pool_members_table(tenant_service, os_service):
...
# 'admin_state_up' in os_vip and isinstance(os_vip['admin_state_up'], bool)):
    ...
    @staticmethod
    def _tenant_service_var(var_name, var_value):
    ...
    @staticmethod
    def _tenant_name(project_id):
        """ Generate tenant name """
        return 'OpenStack-Project-%s' % project_id

    @staticmethod
    def _tenant_service_name(pool_id):
    ...
    def _tenant(project_id, cloud_connector_self_link):
        """ Generate Tenant """
        tenant = {}
        tenant['name'] = LBaaSBuilderBigiqIApp._tenant_name(project_id)
...
#        pass
#    test_service = {}
#    test_service['pool'] = {'tenant_id': '4461ebf4e61349efaed97f420f6010cd'}
#    test_service['vip'] = \
#        {'id': '23948238472984723987293', 'address': '10.20.1.4'}
#    test_conf = ServiceClass()
#    test_conf.openstack_admin_username = 'admin'
#    test_conf.openstack_admin_password = 'openstack'
#    test_conf.openstack_keystone_uri = 'http://10.144.65.83:5000'
#    tenant_manager = BigipTenantManager(test_conf, None)
#    test_readiness = tenant_manager.allow_vip_on_bigips(
#        test_service['pool']['tenant_id'],
#        test_service['vip']['address'], test_conf)
#    print str(test_readiness)
