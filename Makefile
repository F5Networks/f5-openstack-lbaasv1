...
package: docker_all
	...
	cp doc/release_readme.md RELEASE_README.md
	tar czvf build/f5-lbaasv1_$(VERSION)$(RELEASE).tgz RELEASE_README.md SUPPORT.md build/deb_dist/*.deb build/el7/*.noarch.el7.rpm build/el6/*.noarch.el6.rpm
