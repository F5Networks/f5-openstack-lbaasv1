...
package: docker_all
	...
	cp doc/release_readme.rst RELEASE_README.rst
	tar czvf build/f5-lbaasv1_$(VERSION)$(RELEASE).tgz RELEASE_README.rst SUPPORT.rst build/deb_dist/*.deb build/el7/*.noarch.el7.rpm build/el6/*.noarch.el6.rpm
